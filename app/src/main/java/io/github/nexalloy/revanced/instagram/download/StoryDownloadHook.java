...
public class StoryDownloadHook {
     ...
     */
    public static void onStoryOptionsBuilt(XC_MethodHook.MethodHookParam param) {
        if (!FeatureFlags.enableStoryDownload) return;
        if (!(param.getResult() instanceof CharSequence[] original)) return;
    ...
    /** True when {@code builder} returns the CharSequence array the option list is built from. */
    public static boolean buildsOptionLabels(Method builder) {
        Class<?> returnType = builder.getReturnType();
        return returnType.isArray()
                && CharSequence.class.isAssignableFrom(returnType.getComponentType());
    }
     ...
     */
    public static void onStoryOptionClick(XC_MethodHook.MethodHookParam param) {
        if (!FeatureFlags.enableStoryDownload) return;
    ...
    private static void handleStoryMedia(Context ctx, StoryMediaOptions media,
    ...
    private static void showStoryFormatDialog(Context ctx, StoryMediaOptions media,
                                       String username, String mediaId) {
    ...
    private static void startDownload(Context ctx, String url, boolean isVideo,
                               String username, String mediaId) {
