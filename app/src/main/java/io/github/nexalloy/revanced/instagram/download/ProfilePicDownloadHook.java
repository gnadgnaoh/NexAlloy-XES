...
public class ProfilePicDownloadHook {
    ...
    private static void injectLongPress(View view) {
        try {
            ...
            view.setOnLongClickListener(v -> {
                ...
                new Thread(() -> {
                    try {
                        ...
                        ModuleLog.line("(NA|ProfileDL) ❌ download: " + e.getMessage());
                        mainHandler.post(() -> Toast.makeText(ctx,
            ...
            ModuleLog.line("(NA|ProfileDL) ❌ injectLongPress: " + t.getMessage());
        }
    }
    ...
    private static String extractUrl(View view) {
        ...
        ModuleLog.line("(NA|ProfileDL) ❌ all URL strategies failed for " + view.getClass().getName());
        return null;
    }
